...
COMMENT ON COLUMN "MESSAGE"."SEND_TIME" IS '보낸시간';
...
SELECT TO_DATE('2024-09-30 16:59' , 'YYYY-MM-DD HH24:MI') FROM DUAL;
INSERT INTO "MESSAGE" VALUES(SEQ_MESSAGE_NO.NEXTVAL, '배부르당', DEFAULT, TO_DATE('2024-10-01 10:05' , 'YYYY-MM-DD HH24:MI'), 1, 4);
